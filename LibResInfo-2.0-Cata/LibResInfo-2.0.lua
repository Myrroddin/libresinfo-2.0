...
This is the Cataclysm Classic version of the library
...
if not isCata then
    error("This version of LibResInfo-2.0 only works for Cataclysm Classic", 2)
end
...
-- we have different lists of spellIDs single target res spells and mass res spells
local singleSpells, massSpells = {}, {}
